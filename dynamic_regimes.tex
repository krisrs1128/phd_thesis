...
\begin{figure}
  \centering
  \includegraphics[width=0.7\textwidth]{figure/regime_detection/igp_abt_cooccurrence}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figure/regime_detection/changepoint_eb_prior}
