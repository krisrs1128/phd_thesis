...
\begin{figure}
  ...
  \caption{A representation of the dynamic unigram model. The plate diagram
    ...
    which lies on the $V - 1$ dimensional simplex, the black curve at the top.
...
comparison with the standard principal coordinates approach, see Section
\ref{subsec:comparison_with_pcoa}.
